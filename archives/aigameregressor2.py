# [BETA] RANDOM FOREST NETWORK THAT IS USED TO CLASSIFY GAMES
...
try:
    rf = joblib.load("forest_test.joblib")
    print("Forest loaded")
...
joblib.dump(rf, "forest_test.joblib")

# Plot a simple bar chart
ax = feature_importances.plot.hist()
ax.figure.savefig("results-hist.png")
ay = feature_importances.plot.bar()
ay.figure.savefig("results-bar.png")
