...
Instead of using human-crafted evaluatinons (HCE), this AI learns how to play through playing games from itself and learning from playing against itself, starting with zero prior knowledge, except the rules of chess.
